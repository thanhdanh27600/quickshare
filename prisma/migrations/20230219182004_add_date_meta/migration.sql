...
INSERT INTO "new_UrlForwardMeta" ("countryCode", "id", "urlShortenerHistoryId", "userAgent") SELECT "countryCode", "id", "urlShortenerHistoryId", "userAgent" FROM "UrlForwardMeta";
